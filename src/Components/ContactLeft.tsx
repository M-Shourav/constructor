      ...
      {loading ? (
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3 ">
          <div className="flex flex-col gap-2">
            <p className="text-sm uppercase text-gray-700 font-semibold">
              Your Name
            </p>
            <input
              type="text"
              ...
              autoComplete="name"
              required
              className="w-full h-12 px-4 py-2 outline-none rounded-md border-[2px] border-gray-300
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              required
              rows={4}
              className="px-4 py-2 resize-none outline-none rounded-md border-[2px] border-gray-300
            focus-visible:border-orange-500"
            />
          </div>
          <button
        ...
        md:text-lg font-semibold text-white bg-orange-500 rounded-md tracking-wide hover:bg-black
